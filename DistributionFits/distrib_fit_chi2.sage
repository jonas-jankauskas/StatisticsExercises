...
#choices of subdivisions made by students...

subdiv = [-oo, 430, 440, +oo]
#subdiv = [-oo, 428, 438, 442, +oo]
#subdiv = [-oo, 407, 429, 430, 439, 440, 461, +oo]
#subdiv = [-oo, 407, 429, 432, 438, 440, 461]


bin = [n((val - mx)/sigma) for val in subdiv]
num_bin = len(bin) - 1

#uncomment 6 lines below to calculate bins automatically
...
print '---------------'
print 'no. of intervals  =', num_bin
print 'subdivisions      =', print_real_list(subdiv)
print 'observed counts   =', o_values
print 'normalized bins   =', print_real_list(bin)
print 'bin probabilities =', print_real_list(p_values)

print 'expected counts   =', print_real_list(e_values)
...
print '---------------'
print 'H_0: sample is Z-distributed vs. H_A: sample is not Z-distributed:'
if (pval <= conf):
